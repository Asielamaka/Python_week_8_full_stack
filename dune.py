# i am building a very simple FAST API (python) and collecting data from Dune using this Dune's strategy

# dune_api_key = os.getenv("DUNE_QUERY_API_KEY")

# from dune_client.client import DuneClient

# dune = DuneClient("DUNE_QUERY_API_KEY")

# query_result = dune.get_latest_result(5972407)

# using a TTL (redis cache) = 3 days (seconds)

# give me the full python script for my FAST API
...
# # --- Config ---
# DUNE_QUERY_ID = 5972407
# CACHE_TTL = 60 * 60 * 24 * 3  # 3 days in seconds
...
# @app.get("/")
# def root():
#     return {"message": "Welcome to the Dune Data API!",
#             "swagger ui": "/docs",
...
#     try:
#         data = get_data()
#         return {"source": "cache_or_dune", "row_count": len(data), "rows": data}
...
# @app.delete("/cache")
# def bust_cache():
#     """Force-clear the cache so next /data call re-fetches from Dune."""
#     deleted = redis_client.delete(CACHE_KEY)
#     return {"deleted": bool(deleted), "key": CACHE_KEY}
...
# # uvicorn dune:app --host 0.0.0.0 --port 8000
